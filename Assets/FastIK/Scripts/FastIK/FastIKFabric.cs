...
namespace DitzelGames.FastIK
{
    ...
    public class FastIKFabric : MonoBehaviour
    {
        ...
        private void Update()
        {
            float distanceToTarget = Vector3.Distance(transform.position, Attraction.transform.position) - 0.3f;
            float effectFactor = distanceToTarget / affectiveDistance;

            effectFactor = 1 - Mathf.Clamp(effectFactor, 0, 1);
            Target.position = Vector3.Lerp(ACTarget.position, Attraction.transform.position, effectFactor);
        }
